...
export function EmergencyForm() {
  ...
  return (
    <div
      id="assistenza"
      className="relative flex h-full w-full flex-col rounded-[2.75rem] bg-white p-2 shadow-[0_44px_110px_rgba(7,17,31,0.26),0_18px_48px_rgba(37,211,102,0.18),inset_0_1px_0_rgba(255,255,255,0.95)] ring-1 ring-slate-200/80"
    >
      <div className="absolute -inset-1.5 -z-10 rounded-[3rem] bg-linear-to-br from-white via-emerald-100/80 to-slate-300 blur-md" />
      <div className="absolute inset-x-8 -bottom-5 -z-10 h-12 rounded-full bg-slate-950/18 blur-2xl" />
      <div className="relative flex h-full flex-col overflow-hidden rounded-[2.35rem] border border-white bg-linear-to-b from-white via-white to-slate-50 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,1),inset_0_-18px_38px_rgba(15,23,42,0.035)] sm:p-6 lg:p-8">
        ...
        <p className="mt-4 text-base leading-7 font-semibold text-slate-700">
          ...
          c&rsquo;è copertura nella zona, vieni ricontattato in{' '}
        ...
        <div className="mt-6 grid flex-1 gap-4">
          <label className="grid gap-2">
            ...
            <input
              ...
              className="rounded-2xl border border-slate-200 bg-white px-4 py-4 text-base font-bold shadow-inner shadow-slate-950/[0.03] outline-none ring-[#25d366]/30 transition focus:border-[#25d366] focus:ring-4"
            />
          </label>
          ...
          <fieldset className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-[0_14px_34px_rgba(15,23,42,0.06)]">
          ...
          <div className="grid gap-3 rounded-[2rem] border border-emerald-200 bg-white p-4 shadow-[0_18px_42px_rgba(6,95,70,0.10)]">
