  ...
  return <div className="bc-page">
    ...
    <main>
      <section className="bc-hero"><div className="bc-wrap bc-hero-grid">
        <div className="bc-intro"><p className="bc-eyebrow"><span /> SOCCORSO STRADALE · BRESCIA</p><h1>Auto ferma?<br />Il prossimo passo<br /><em>è una chiamata.</em></h1><p className="bc-lead">Carroattrezzi a <strong>Brescia e provincia.</strong> Parla subito con il riferimento di zona e organizza il recupero, senza compilare moduli.</p><div className="bc-promises"><span><Icon name="check" />Preventivo prima dell’uscita</span><span><Icon name="check" />Nessun obbligo di accettare</span></div><div className="bc-route" aria-hidden="true"><span className="bc-route-pin">⌖</span><span className="bc-route-line" /><span className="bc-route-truck">↗</span><span>BRESCIA<br /><b>Partiamo da dove sei.</b></span></div></div>
        <div className="bc-contact"><div className="bc-contact-top"><span className="bc-availability"><i /> ASSISTENZA TELEFONICA 24/7</span><span>BS</span></div><h2>Disponibili per la tua chiamata<br /><strong>in questo momento.</strong></h2><div className="bc-clock"><span>ORA LOCALE · BRESCIA</span><time suppressHydrationWarning>{time || '—:—:—'}</time></div><CallButton placement="hero" /><p className="bc-call-note">Un contatto diretto. Nessun modulo da compilare.</p><div className="bc-contact-bottom"><Icon name="shield" /><p><strong>Chiedi il preventivo. Poi decidi.</strong><span>Prezzo e tempi del mezzo si confermano al telefono.</span></p></div></div>
